...
const CalenderReserves = () => {
    ...
    const inService = [
        [new DateObject({calendar: persian, locale: persian_fa}).setDay(12).format(), new DateObject({
            calendar: persian,
            locale: persian_fa
        }).setDay(13).format()],
        [new DateObject({calendar: persian, locale: persian_fa}).setDay(27).format(), new DateObject({
            calendar: persian,
            locale: persian_fa
        }).setDay(27).format()],
    ];
