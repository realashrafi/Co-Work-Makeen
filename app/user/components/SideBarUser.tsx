...
const SideBarUser = ({visible,setVisible}:any) => {
    ...
    return (
        <div
            className={`flex-col transition-all lg:w-[20%] rounded-xl pr-[1%]   flex items-center lg:visible ${visible ? 'right-0' : '-right-[310px]'} lg:top-0 -top-24 lg:right-0 fixed pt-32 lg:pt-[11px] bg-[#0A2E65]`}>
