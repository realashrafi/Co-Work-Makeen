...
const UploadImage = () => {
    ...
    return (
        <div>
            <div className={'relative cursor-pointer z-10'} onClick={() => setShowModal(true)}>
                ...
                {data?.profile_picture == null ?
                    <svg width="90px" className={'animate-pulse'} height="90px" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                        <path fill="#494c4e"
