    ...
    return (
        <section className={'bg-[#002256] w-full flex flex-col relative '}>
            ...
            <div className={'flex w-full relative  pt-[123px]'}>
                <div className={'w-1/19 mr-[7%] '}>
                    <div data-aos="fade-right" className={'w-[550px]  pr-[5%]'}>
                        <h2 className={'text-[22px] text-[#FF792C] pt-[173px]'} style={{direction: "rtl"}}>اتاق
                            جلسات</h2>
                        <p className={'w-[550px] pr-[5%] pl-[6%] text-[16px] text-[#DCDCDC] pt-8 mx-auto '}
                           style={{direction: "rtl"}}>
                ...
                <div data-aos="fade-left" className={'w-1/19 mr-[10%]'}>
                    <Image src={img} className={'z-20'} alt={''}/>
                    <div className={'mt-2 ml-[7px]'}>
            ...
            <div className={'w-[71%] h-[294px] mx-auto rounded-[24px]  mt-[50px] bg-[#0A2E65] flex'}>
                ...
                <div className={'flex ml-[52px] items-center'}>
