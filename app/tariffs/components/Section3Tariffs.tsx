...
const Section3Tariffs = () => {
    ...
    return (
        <section className={'bg-[#002256] w-[100%] flex lg:flex-col lg:flex-nowrap flex-wrap relative '}>
            ...
            {/*     className="lg:w-[170px] lg:visible invisible lg:absolute lg:right-0 lg:-top-20 lg:h-[219px] opacity-50 bg-[#FF792C] rounded-l-full blur-[100px]"/>*/}
            {/*<div data-aos={'fade'} data-aos-delay="800"*/}
            {/*     className="lg:w-[170px]  lg:visible invisible lg:absolute lg:left-0 lg:badge-lgtop-20 lg:h-[219px] opacity-50 bg-[#FF792C] rounded-r-full blur-[100px]"/>*/}
            <div className={'flex w-full relative mx-auto lg:pt-[123px]'}>
                <div className={'lg:w-1/19 lg:mr-[7%] '}>
                    <div  className={'lg:w-[550px]  -mr-12 lg:pr-[5%]'}>
                ...
                <div  className={'lg:w-1/19 lg:visible invisible w-full  mx-auto lg:mr-[10%]'}>
            ...
            <div
                ...
                <div className={'flex lg:pt-0 pt-12  lg:ml-[52px] items-center'}>
