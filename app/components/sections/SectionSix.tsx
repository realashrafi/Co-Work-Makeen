...
const SectionSix = () => {
    return (
        <section className={'bg-[#002256] pt-[180px] pb-[120px] flex justify-center'}>
            ...
            <div className="relative group cursor-pointer -mx-[15px] rounded-[18px] duration-500 scale-[85%] w-[275px] h-[275px] bg-[#FF792C] ">
                <div className="">
                    ...
                    <p className="group-hover:opacity-100 absolute bottom-6 px-8 text-[12px] text-white duration-500 opacity-0"
                       style={{direction: "rtl"}}>
            ...
            <div className="relative group cursor-pointer -mx-[15px] rounded-[18px] duration-500 scale-[85%] w-[275px] h-[275px] bg-[#026AE1] ">
                <div className="">
