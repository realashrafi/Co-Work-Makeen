    ...
    return (
        <section className={'bg-[#002256]'}>
            <div className={'flex justify-center relative flex-col'}>
                ...
                <p className={'w-[557px] text-justify text-zinc-300 text-base font-normal pt-8 mx-auto '} style={{direction:"rtl"}}>فعالیت در محیط کاری با حضور افراد
                ...
                <Image src={gifIcon} alt={''} className={'absolute top-28 scale-[90%] -left-24'}/>
                <FlatGroupsS2/>
                <div className={'pt-[155px] pb-[52px] flex-warp lg:flex relative '}>
                    <div>
                        <div className={' lg:w-[755px]   relative '}>
                            <Image src={videoPre} width={725} alt={'videoPre'}/>
                            <div
                                className={'w-[101px] flex justify-center items-center h-[95px] bg-[#002256] rounded-full absolute z-10 right-[-20px] top-[220px]'}>
                    ...
                    <div className={'flex  justify-center w-[425px] mx-auto flex-col '}>
                        <h3 className={'text-white text-[22px] font-bold text-center pb-[10px]'}>تور مجازی کوورک مکین</h3>
                        <svg width="425" height="1" viewBox="0 0 425 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line y1="0.5" x2="425" y2="0.5" stroke="#FF792C"/>
                        </svg>
                        <p className={'pt-[14px] text-justify text-slate-50 text-base font-normal'} style={{direction:"rtl"}} >آکادمی مکین همواره در تلاش است تا فضای
