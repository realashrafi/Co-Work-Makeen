                ...
                <div className={'flex w-[100%]'}>
                    <div className={'flex flex-col w-[81.25%]'}>
                        ...
                        <div className={'w-[100%] h-[1724px] flex justify-center'}>
                            <div
                                className={'w-[88.97%] flex flex-col h-[1570px] mt-[56px] rounded-[12px] bg-[#FFFEFF]'}>
                                ...
                                <div className={'flex  mt-[35px] mx-[67px] justify-between'}>
                                    ...
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>تعداد کل صندلی های
                                            کوورک</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                            dir={'rtl'}>
                                ...
                                <div className={'flex  mt-[35px] mx-[67px] justify-between'}>
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>هزینه اشتراک بلند
                                            مدت
                                            کوورک</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                    ...
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>هزینه روزانه
                                            کوورک</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                            dir={'rtl'}>
                                ...
                                <div className={'flex  mt-[39px] mx-[67px] justify-between'}>
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>ساعت پایان رزرو
                                            روزانه</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                            dir={'rtl'}>
                                    ...
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>ساعت شروع رزرو
                                            روزانه</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                            dir={'rtl'}>
                                ...
                                <div className={'flex  mt-[35px] mx-[67px] justify-end'}>
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>انتخاب بازه ساعتی
                                            اتاق
                                            جلسات</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                ...
                                <div className={'flex  mt-[39px] mx-[67px] justify-between'}>
                                    ...
                                    <div className={'w-[39.57%]'}>
                                        <p className={'text-black text-sm font-normal'} dir={'rtl'}>تیتر مد نظر را وارد
                                            کنید</p>
                                        <select
                                            className={'w-[100%] px-4 mt-[8px] h-[40px] border-[#C4C4C4] bg-[#FFFEFF] border-[1px] rounded-[5px]'}
                                            dir={'rtl'}>
