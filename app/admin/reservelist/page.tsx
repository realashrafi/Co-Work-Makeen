                        ...
                        <div
                            ...
                            <div className={'flex justify-between mt-[17px]'}>
                                ...
                                <div className={'flex items-center mr-[29px]'}>
                                    <p className={'text-[#0075FF] text-base font-normal mr-[8px]'}>لیست رزرو کوورک</p>
                            ...
                            <div
                                ...
                                dir={'rtl'}>
                                <p className={'text-[#222222] text-base font-normal -mr-[3%]'}>نام و نام خانوادگی</p>
...
<rect width="24" height="24" fill="white"/>
                        ...
                        <div
                            ...
                            <div className={'flex justify-between mt-[17px]'}>
                                ...
                                <div className={'flex items-center mr-[29px]'}>
                                    <p className={'text-[#0075FF] text-base font-normal mr-[8px]'}>لیست رزرو اتاق
                                        جلسات</p>
                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g id="more_vert" clipPath="url(#clip0_664_3783)">
