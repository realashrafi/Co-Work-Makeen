        ...
        <div>
            ...
            <ReactModal
                ...
                <div className={'w-[100%] flex justify-end mt-[60px]  pr-[48px]'}>
                    <p className={'text-[#000000] text-lg font-medium pr-[10px]'}>مقاله ها</p>
                ...
                <div className={'flex justify-end mt-[8px] pr-[77px]'}>
                    <p className={'text-neutral-600 text-base font-normal'} dir={'rtl'}>لطفا اطلاعات مقاله های خود را در
                        قسمت های زیر را وارد کنید
                    </p>
                </div>
                <div className={'flex w-[85%] justify-between mx-auto'}>
                    <div className={'flex w-[50%] flex-col mt-[34px] text-black text-sm font-normal mx-auto'}
                         dir={'rtl'}>
                        تاریخ درج مقاله
                        <input type={'text'} dir={'rtl'} placeholder={'تاریخ درج مقاله را وارد کنید'}
                ...
                <div  className={'flex cursor-pointer flex-col w-[85%] mx-auto text-black text-sm font-normal mt-[70px]'} dir={'rtl'}>
                    بارگذاری تصویر
                    <div
                ...
                <div className={'flex w-[85%] mx-auto mt-[50px] justify-end'}>
                <button onClick={()=>setShowModal(false)} className={'w-[265px] h-[40px] flex justify-center items-center bg-[#0075FF] rounded-[5px] text-white'}>
                    ذخیره
                </button>
                </div>
            </ReactModal>
