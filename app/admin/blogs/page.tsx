                ...
                <div className={'w-[100%] flex justify-center h-[1726px]'}>
                    <div className={'w-[88.97%] flex flex-col h-[1570px] mt-[56px] rounded-[12px] bg-[#FFFEFF]'}>
                        <div className={'w-[100%] flex justify-end mt-[24px]  pr-[38px]'}>
                            <p className={'text-[#000000] text-lg font-medium pr-[10px]'}>لیست مقالات</p>
                        ...
                        <div className={'flex justify-end mt-[8px] pr-[67px]'}>
                            <p className={'text-neutral-600 text-base font-normal'} dir={'rtl'}>کاربر محترم ، در این
                                بخشکاربر محترم ، در این بخش می توانید مقالات موجود در سایت را مشاهده ، ویرایش و حذف کنید
                            </p>
                        </div>
                       <AddBlogs/>
                        <div
                            ...
                            <div
                                className={'flex justify-between items-center h-[73px] w-[94.16%]  mx-auto border-b-[1px] border-sky-950 border-opacity-20'}
                                dir={'rtl'}>
                                <div className={'text-neutral-700 text-sm font-bold'}>ردیف</div>
                                <div className={'text-neutral-700 text-sm font-bold'}>نام مقاله</div>
                                <div className={'text-neutral-700 text-sm font-bold'}>تاریخ درج</div>
                                <div className={'text-neutral-700 text-sm font-bold'}>تاریخ ویرایش</div>
                                <div className={'text-neutral-700 text-sm font-bold'}>عملیات</div>
                            </div>
                            <div className={'flex w-[94.16%] mx-auto flex-col'}>
                                {data.map(item => (
                                    <div key={item.id}
                                         className={'flex h-[70px] justify-between items-center border-b-[1px] border-sky-950 border-opacity-20'}
                                         dir={'rtl'}>
                                        <div
                                            className={'pr-[5px]  text-center text-neutral-700 text-xs font-normal'}>{item.id}</div>
                                        <div
                                            className={' text-center text-neutral-700 text-xs font-normal'}>{item.name}</div>
                                        <div
                                            className={'pl-[15px] text-center text-neutral-700 text-xs font-normal'}>{item.startDate}</div>
                                        <div
                                            className={'pl-[] text-center text-neutral-700 text-xs font-normal'}>{item.endDate}</div>
